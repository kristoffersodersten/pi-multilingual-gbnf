...
export class MultilingualGrammarValidator {
    ...
    calculateMetrics(original, normalized) {
 ...
 */
class FileOpsGrammar {
    validate(text, lang, constraint) {
        const errors = [];
        const warnings = [];
        ...
        const pattern = new RegExp(`^(WRITE|READ|EDIT|DELETE|${actions})\\s+([\\w\\\\.\\/\\\\-\\u00e4\\u00e5\\u00f6\\u00c4\\u00c5\\u00d6]+)(?:\\s+(\\d+\\s*(?:bytes?|KB|MB|GB|byte|kilobyte|megabyte|kilobyte)?))?$`, 'gmi');
